            ...
            <div class="flex">
                <div class="flex">
                    ...
                    <div style="margin-left: 6px;">
                        <a href="http://127.0.0.1/Vo1d47/profile.php?username=<?php echo $post_owner_username; ?>" class="post-owner-name"><?php echo $post_owner_fullname; ?> -@<?php echo $post_owner_username ?></a>
