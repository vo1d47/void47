    ...
    <main>
        <div class="login-img-reg-container">
            <div id="left-asset-wrapper">
                <h2 id="login-left-text">“Hacking is a talent. You won't learn it at school. It's like being Messi or C.Ronaldo. If you were born to become a Hacker, it's your destiny. Otherwise, you'll be Hacked.”<br>
― FrostDeDay <br></h2>
